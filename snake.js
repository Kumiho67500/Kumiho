...
function draw() {
  ...
  if (random() < 0.01) placeYellowFood();
  if (random() < 0.002) placeFlashingFood();
  if (random() < 0.01) placeBlueFood();
  if (random() < 0.01) placeExplosiveFood();
...
function placeNutrientFood() {
  nutrientFood.push(randomEmptyCell());
}
